    ...
    return (
        <> 
            <div className='flex flex-row bg-gray-200'>
                <div className="h-screen p-2 border-r border-gray-400 md:flex w-72 hidden">
                        ...
                        <div className="flex p-2 flex-grow flex-col gap-2 overflow-y-auto bg-white">
                            ...
                            <div className="flex flex-grow flex-col gap-2">
                                ...
                                <div className={ (open === 'allergies' ? 'rounded-t-lg': 'rounded-lg') + ' flex flex-row items-center justify-between p-2 bg-gray-700 cursor-pointer'} 
                                    ...
                                    <div className={(open === 'allergies' ? 'flex': 'hidden') + ' rounded-b-lg flex-row gap-1 p-2 flex-wrap bg-gray-100'}>
                                        {
                                            FILTERS.Allergies.map((value) => (
                                                <CheckToggle tittle={value} handleSelectFilter={handleSelectFilter} />
                                            ))
